...
const paginaConfirmacion = async(req, res) =>
{
     ...
     res.render("templates/mensaje",{
            ...
            buttonText: "Ingresar a BienesRaices-240603!",
...
const resetearPassword = async (req, res) => {
    ...
    console.log(`El usuario con correo: ${email} esta solicitando un reseteo de contraseña.`);
    ...
    try {
        ...
        console.log("Error al intentar enviar el correo de recuperación", error);
        return res.render("auth/recuperarPassword", {
...
const autenticar = async (req, res) => {
    ...
    // Si el password es correcto, reseteamos los intentos
...
export { formularioLogin, formularioRegistro, registrarUsuario, formularioRecuperacion, paginaConfirmacion, resetearPassword, formularioActualizacionPassword, actualizarPassword,autenticar}