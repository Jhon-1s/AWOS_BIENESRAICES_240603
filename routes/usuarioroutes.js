...
// Mock route para pruebas de POST
router.post("/createUser", (req, res) => {
    ...
    res.json({
        status: 200,
        message: `Se ha solicitado la creación de un nuevo usuario con nombre: ${nuevoUsuario.nombre}, correo: ${nuevoUsuario.correo} y matrícula: ${nuevoUsuario.matricula}`
    });
});
